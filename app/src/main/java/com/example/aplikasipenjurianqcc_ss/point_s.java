...
public class point_s extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_point_s);
        auto_1 = (AutoCompleteTextView)findViewById(R.id.isi_spinner_s1);
        ArrayAdapter<String> adapter_1 = new ArrayAdapter<>(
                this,R.layout.drop_down_menu,list_item_penilaian.value_6
        );
        ...
        myRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(point_s.this, "Error!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void input_database(View view) {
        if(auto_1.getText().toString().equals("")){
            Toast.makeText(point_s.this, "Mohon lengkapi data terlebih dahulu!", Toast.LENGTH_SHORT).show();
        }else{
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            ...
            Toast.makeText(point_s.this, "Nilai Dimasukkan", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(point_s.this,list_item_penilaian.class));
        }
