...
public class point_ss_h extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_point_ss_h);
        auto_1 = (AutoCompleteTextView)findViewById(R.id.isi_spinner_ss_h1);
        auto_2 = (AutoCompleteTextView)findViewById(R.id.isi_spinner_ss_h2);
        ...
        myRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(point_ss_h.this, "Error!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void input_database(View view) {
        if(auto_1.getText().toString().equals("") || auto_2.getText().toString().equals("")){
            Toast.makeText(point_ss_h.this, "Mohon lengkapi data terlebih dahulu!", Toast.LENGTH_SHORT).show();
        }else{
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            ...
            Toast.makeText(point_ss_h.this, "Nilai Dimasukkan", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(point_ss_h.this,list_item_penilaian.class));
        }
    }
}