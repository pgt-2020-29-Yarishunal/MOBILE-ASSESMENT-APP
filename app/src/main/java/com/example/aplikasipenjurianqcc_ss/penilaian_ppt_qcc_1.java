...
public class penilaian_ppt_qcc_1 extends AppCompatActivity {
...
String sub_sec = "a";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penilaian_ppt_qcc1);
        ...
        myRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(penilaian_ppt_qcc_1.this, "Error!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void input_database(View view) {
        if(!rad1.isChecked() && !rad2.isChecked() && !rad3.isChecked() && !rad4.isChecked()){
            Toast.makeText(penilaian_ppt_qcc_1.this, "Mohon Lengkapi Data!!", Toast.LENGTH_SHORT).show();
        }else{
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            ...
            Toast.makeText(penilaian_ppt_qcc_1.this, "Nilai Dimasukkan", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(penilaian_ppt_qcc_1.this,list_item_penilaian.class));
        }
    }
