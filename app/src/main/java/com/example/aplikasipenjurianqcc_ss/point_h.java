...
public class point_h extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_point_h);
        auto_1 = (AutoCompleteTextView)findViewById(R.id.isi_spinner_h1);
        auto_2 = (AutoCompleteTextView)findViewById(R.id.isi_spinner_h2);
        auto_3 = (AutoCompleteTextView)findViewById(R.id.isi_spinner_h3);
        auto_4 = (AutoCompleteTextView)findViewById(R.id.isi_spinner_h4);
        ...
        myRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                data1 = dataSnapshot.child("h1").getValue(String.class);
                data2 = dataSnapshot.child("h2").getValue(String.class);
                data3 = dataSnapshot.child("h3").getValue(String.class);
                data4 = dataSnapshot.child("h4").getValue(String.class);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(point_h.this, "Error!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void input_database(View view) {
        if(auto_1.getText().toString().equals("") || auto_2.getText().toString().equals("")||auto_3.getText().toString().equals("")||auto_4.getText().toString().equals("")){
            Toast.makeText(point_h.this, "Mohon lengkapi data terlebih dahulu!", Toast.LENGTH_SHORT).show();
        }else{
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            ...
            if(data1.equals("")){
                myRef.child("h1").setValue(login_page.nip_juri +":"+auto_1.getText().toString());
            }else{
                if(data1.contains(login_page.nip_juri)){
                    myRef.child("h1").setValue(data1.replace(data1_split,login_page.nip_juri +":"+auto_1.getText().toString()));
                }else{
                    myRef.child("h1").setValue(data1 +","+ login_page.nip_juri +":"+auto_1.getText().toString());
                }
            }
            if(data2.equals("")){
                myRef.child("h2").setValue(login_page.nip_juri +":"+auto_2.getText().toString());
            }else{
                if(data2.contains(login_page.nip_juri)){
                    myRef.child("h2").setValue(data2.replace(data2_split,login_page.nip_juri +":"+auto_2.getText().toString()));
                }else{
                    myRef.child("h2").setValue(data2 +","+ login_page.nip_juri +":"+auto_2.getText().toString());
                }
            }
            if(data3.equals("")){
                myRef.child("h3").setValue(login_page.nip_juri +":"+auto_3.getText().toString());
            }else{
                if(data3.contains(login_page.nip_juri)){
                    myRef.child("h3").setValue(data3.replace(data3_split,login_page.nip_juri +":"+auto_3.getText().toString()));
                }else{
                    myRef.child("h3").setValue(data3 +","+ login_page.nip_juri +":"+auto_3.getText().toString());
                }
            }
            if(data4.equals("")){
                myRef.child("h4").setValue(login_page.nip_juri +":"+auto_4.getText().toString());
            }else{
                if(data4.contains(login_page.nip_juri)){
                    myRef.child("h4").setValue(data4.replace(data4_split,login_page.nip_juri +":"+auto_4.getText().toString()));
                }else{
                    myRef.child("h4").setValue(data4 +","+ login_page.nip_juri +":"+auto_4.getText().toString());
                }
            }

            Toast.makeText(point_h.this, "Nilai Dimasukkan", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(point_h.this,list_item_penilaian.class));
        }
    }
}