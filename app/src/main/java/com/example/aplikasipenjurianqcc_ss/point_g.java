...
public class point_g extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_point_g);
        auto_1 = (AutoCompleteTextView)findViewById(R.id.isi_spinner_g1);
        ...
        myRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(point_g.this, "Error!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void input_database(View view) {
        if(auto_1.getText().toString().equals("")){
            Toast.makeText(point_g.this, "Mohon lengkapi data terlebih dahulu!", Toast.LENGTH_SHORT).show();
        }else{
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            ...
            Toast.makeText(point_g.this, "Nilai Dimasukkan", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(point_g.this,list_item_penilaian.class));
        }
    }
}