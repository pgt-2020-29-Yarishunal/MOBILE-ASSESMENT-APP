...
public class penilaian_ppt_qcc_4 extends AppCompatActivity {
    TextView teks1,teks2,teks3,teks4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef1.addValueEventListener(new ValueEventListener() {
                        ...
                        if(data1.contains(",")){
                            ...
                            for (int i=0;i< split_1.length;i++) {
                                if (split_1[i].contains(login_page.nip_juri)) {
                                    ...
                                    }else if(data1_split.contains(value4)){
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(penilaian_ppt_qcc_4.this, "Error!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void input_database(View view) {
        if(!rad1.isChecked() && !rad2.isChecked() && !rad3.isChecked() && !rad4.isChecked()){
            Toast.makeText(penilaian_ppt_qcc_4.this, "Mohon Lengkapi Data!!", Toast.LENGTH_SHORT).show();
        }else{
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            ...
            if(data1.equals("")){
                if (rad1.isChecked()){
                    ...
                    myRef.child(sub_sec).setValue(login_page.nip_juri +":"+value4);
                }else{}
            }else{
                if(data1.contains(login_page.nip_juri)){
                    if (rad1.isChecked()){
                        ...
                        myRef.child(sub_sec).setValue(data1.replace(data1_split,login_page.nip_juri +":"+value4));
                    }else{}
                }else{
                    if (rad1.isChecked()){
                        ...
                        myRef.child(sub_sec).setValue(data1 +","+ login_page.nip_juri +":"+value4);
                    }else{}
                }
            }
            Toast.makeText(penilaian_ppt_qcc_4.this, "Nilai Dimasukkan", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(penilaian_ppt_qcc_4.this,list_item_penilaian.class));
        }
    }
    ...
    public void radio1(View view) {
        if(rad1.isChecked()){
            ...
            teks4.setTextColor(Color.parseColor("#3D3D3D"));
        }else{
            rad1.setChecked(true);
            rad2.setChecked(false);
            rad3.setChecked(false);
    ...
    public void radio4(View view) {
        if(rad4.isChecked()){
            ...
            teks2.setTextColor(Color.parseColor("#3D3D3D"));
            teks3.setTextColor(Color.parseColor("#3D3D3D"));
            teks4.setTextColor(Color.parseColor("#000000"));
        }else{
            rad1.setChecked(false);
            rad2.setChecked(false);
            rad3.setChecked(false);
